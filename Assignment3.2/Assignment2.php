<?php
   ...
   $assignment = new Project("Assignment2.0");
   $assignment1 = new Project("Assignment2.1");
?>
 <!DOCTYPE html>
<html lang="en">
  <head>
...
//this function is from w3school
  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="Assignment2.php">Assignment2</a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </div>
    ...
    <a name="#top"></a>
	<div>
    	<a href="#zero">Assignment 2.0  &raquo;</a>
    	<a name="zero"></a>
    	<a href="#one">Assignment 2.1  &raquo;<br></a>
	</div>
	
	
	<br><br>
	<h1> Assignment 2.0 <br><br> </h1>
	<?php
		echo "<pre>";
