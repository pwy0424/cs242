...
$(document).ready(function(){
	$("#buttom_animation").click(function(){
	   $("#move").animate({left:'450px'});
	});
});
</script>
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="buttons">
        ...
        <button id="buttom_animation">JQuery Animation Test</button>
	<div id="move" style="background:green;height:20px;width:120px;position:absolute;"><p align="center">Moevable Parts</p></div>
