...
public class LANSimulation {
	...
	public static void simulate() {
		...
		System.out.print(network.firstNode.requestWorkstationPrintsDocument(network, "Filip",
		...
		try {
			...
			System.out.print(network.firstNode.requestWorkstationPrintsDocument(
					network, "UnknownWorkstation", "does not matter", "does not matter",
					report));
		...
		System.out.print(network.firstNode.requestBroadcast(network, report));
		System.out.println(" (expects true);");
