...
public class LANTests extends TestCase {
	...
	public void testWorkstationPrintsDocument() {
		...
		assertTrue("PrintSuccess ", network.firstNode.requestWorkstationPrintsDocument(
				network, "Filip", "Hello World", "Andy", report));
		assertFalse("PrintFailure (UnkownPrinter) ", network.firstNode
				.requestWorkstationPrintsDocument(network, "Filip", "Hello World",
						"UnknownPrinter", report));
		assertFalse("PrintFailure (print on Workstation) ", network.firstNode
				.requestWorkstationPrintsDocument(network, "Filip", "Hello World",
						"Hans", report));
		assertFalse("PrintFailure (print on Node) ", network.firstNode
				.requestWorkstationPrintsDocument(network, "Filip", "Hello World", "n1",
						report));
		assertTrue("PrintSuccess Postscript", network.firstNode
				.requestWorkstationPrintsDocument(network, "Filip",
						"!PS Hello World in postscript", "Andy", report));
		assertFalse("PrintFailure Postscript", network.firstNode
				.requestWorkstationPrintsDocument(network, "Filip",
	...
	public void testBroadcast() {
		...
		assertTrue("Broadcast ", network.firstNode.requestBroadcast(network, report));
	}
	...
	public void testOutput() {
		...
		try {
			...
			network.firstNode.requestWorkstationPrintsDocument(network, "Filip", "Hello World",
					"Andy", report);
			report
			...
			network.firstNode.requestWorkstationPrintsDocument(network, "Filip",
					"!PS Hello World in postscript", "Andy", report);
			report
			...
			network.firstNode.requestBroadcast(network, report);
	...
	static public class PreconditionViolationTestCase extends ExceptionTestCase {
		...
		public void test() {
			...
			network.firstNode.requestWorkstationPrintsDocument(network, "UnknownWorkstation",
